...
function diceCallback(a,b,d){var g=a*sp,e=0==g?0:Math.ceil(g/10)-1,c=b[e][0],e=b[e][1];setHP(hp-c);setSP(sp-e);b=function(){loadPage(d)};a="You have rolled a  "+a+" giving you "+g+" attack point(s)";c=0==Number(c)+Number(e)?"<br><br>You have lost no health points or strength points</td></tr></table>":"<br><br>You have lost:<table><tr><td>Health points:</td><td>"+c+"</td></tr><tr><td>Strength points:</td><td>"+e+"</td></tr></table>";g="<br><br>Remaining:<table><tr><td>Health points:</td><td>"+hp+"</td></tr><tr><td>Strength points:</td><td>"+
sp+"</td></tr></table>";0>=hp?showMsg("warning",a+"<br><br>You have run out of health points.<br><br>YOU DIE",goDie):5>=hp?showMsg("info",a+"<br><br>You have made it through, but only just..."+c+g,b):showMsg("success",a+"<br><br>You have made it through!"+c+g,b)}
function mergeImg(){var a=!1,b=0,d=setInterval(function(){var g=(a=!a)?"./img/ouija_bottom.png":"./img/ouija_top.png",e=document.getElementById("gameplay-img");e.classList.add("gameplay-img-fadeout");var c=setTimeout(function(){e.src=g;e.classList.remove("gameplay-img-fadeout");b++;2==b&&(clearInterval(d),clearTimeout(c))},250)},1E3)}function showKey(){var a=document.getElementById("gameplay-img-overlay");a.src="./img/flower_to_key.gif";setTimeout(function(){a.src="./img/flower_power.png"},1E3)}
function findKey(){showMsg("success","You found the key!",function(){loadPage("./pages/page_07.html")})}function confirmGuard(a){showMsg("confirm","Are you sure you want to pick the "+a+"?",function(){"blue guard"==a?loadPage("./pages/page_09.html"):"red guard"==a&&goDie()},null)}function confirmCandleMace(a){showMsg("confirm","Are you sure you want to pick the "+a+"?",function(){"candle"==a?loadPage("./pages/page_10.html"):"mace"==a&&loadPage("./pages/page_11.html")},null)}
function confirmGhoulName(){showMsg("input","What is the name of the sniggering ghoul?<br><br>",function(a,b){"casper"==b.toLowerCase()?(showMsg("success","Your guess is correct..."),loadPage("./pages/page_28.html")):showMsg("warning","Your guess is WRONG!")})}
...
function drinkPotion(a,b){showMsg("info",b?"You drink the potion, and feel invigorated!<br><br>2 health points have been added to your total":"You drink the potion, and feel awful!<br><br>2 health points have been removed from your total",function(){b?setHP(Number(hp)+Number(2)):setHP(Number(hp)-Number(2));loadPage(a)},null)}
function confirmWeapon(a){showMsg("confirm","Are you sure you want to choose the "+a+"?",function(){"sword"==a.toLowerCase()?loadPage("./pages/page_36.html"):"bomb"==a.toLowerCase()?loadPage("./pages/page_37.html"):"axe"==a.toLowerCase()&&loadPage("./pages/page_38.html")})}function choseWeapon(a,b){"hp"==b.toLowerCase()?setHP(Number(hp)+Number(a)):"sp"==b.toLowerCase()&&setSP(Number(sp)+Number(a));loadPage("./pages/page_39.html")}
